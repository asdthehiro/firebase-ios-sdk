...
class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    log("5 6");
    log("n1 ${json['billing_input_by_customer']}");
    log("n2 ${json['minimum_order_limit']}");
    log("n3 ${json['wallet_status']}");
    log("n4 ${json['loyalty_point_status']}");
    log("n5 ${json['loyalty_point_exchange_rate']}");
    log("n6 ${json['loyalty_point_minimum_point']}");
    //edit here
    billingInputByCustomer =
        json['billing_input_by_customer'] ?? 1;
    //edit here
    minimumOrderLimit = json['minimum_order_limit'] ?? 1;
    //edit here
    walletStatus = json['wallet_status'] ?? 0;
    loyaltyPointStatus = json['loyalty_point_status'] ?? 0;
    log("5 7");
    loyaltyPointExchangeRate =
        json['loyalty_point_exchange_rate'] ?? 0;
    loyaltyPointMinimumPoint =
        json['loyalty_point_minimum_point'] ?? 0;
    log("6");
