...
import 'package:flutter_sixvalley_ecommerce/view/basewidget/custom_slider/carousel_controller.dart' as cros;
import 'package:flutter_sixvalley_ecommerce/view/basewidget/custom_slider/utils.dart';
import 'carousel_controller.dart' as cc;
...
class CarouselSlider extends StatefulWidget {
  ...
  CarouselSlider(
      {required this.items,
        ...
        this.disableGesture,
        cros.CarouselController? carouselController,
        super.key})
      : itemBuilder = null,
        itemCount = items != null ? items.length : 0,
        _carouselController = carouselController != null
            ? carouselController as cc.CarouselControllerImpl
            : cros.CarouselController() as cc.CarouselControllerImpl;
