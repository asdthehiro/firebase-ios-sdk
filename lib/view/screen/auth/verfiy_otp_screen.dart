          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        locale.locale.languageCode == "en" ? "confirm mobile number": " تأكيد رقم الهاتف",
                ...
                Center(
                  child: Text(
                    locale.locale.languageCode == "en" ? "Enter code": "أدخل الرمز",
                    textAlign: TextAlign.right,
                    style: TextStyle(
                      color: const Color(0xFF292929),
                      fontSize: 17,
                ...
                Center(
                  child: GestureDetector(
                    onTap: () {
                      // onPressedLogin();
                      value.verifyCode(widget.phone,verificationCode??"",route);
                    },
                    child: SizedBox(
                      width: 120,
                      height: 35,
